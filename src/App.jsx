...
export default function App() {
  ...
  // =======================================================
  // 🆕 FUNCIÓN PARA CAMBIAR EL ESTADO DE PAGO (PAGADO/PENDIENTE)
  // =======================================================
  const handleTogglePagoAnticipo = async (anticipo) => {
    ...
    try {
      ...
      await loadAnticipos(); // Refrescar datos globales
        ...
        <div className="p-6">
          ...
          {activeTab === "archivedAnticipos" && (
            <HistorialAnticipos
              ...
              onTogglePago={handleTogglePagoAnticipo} // PROP AGREGADA
