                ...
                >
                  ...
                  <td className="px-4 py-3 items-center">
                    ...
                    <button
                      ...
                      className={`inline-flex cursor-pointer items-center px-3 py-1.5 rounded-full text-[11px] font-semibold uppercase shadow-sm transition-all duration-200 ease-in-out transform hover:scale-[1.02] ${
                        !(row.estado === "VIGENTE")
                          ? "bg-red-100 text-red-700 border-red-200 hover:bg-red-200"
                          : "bg-green-100 text-green-700 border-green-200 hover:bg-green-200"
                      }`}
                    >
                      {!(row.estado === "VIGENTE") ? "ANULADO" : "Vigente"}
                    </button>
                  </td>
