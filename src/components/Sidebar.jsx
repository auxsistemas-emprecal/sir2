  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-6 bg-slate-800 shrink-0">
        <span className="text-xl font-bold tracking-wider text-emerald-400">EMPRECAL S.A.</span>
      ...
      <nav className="mt-6 px-4 space-y-2 flex-1">
        <NavItem icon={<Home size={20}/>} label="Inicio" active={activeTab === 'inicio'} onClick={() => setActiveTab('inicio')} />

        <NavItem icon={<FileText size={20}/>} label="Generar Remisión" active={activeTab === 'generador'} onClick={() => setActiveTab('generador')} />

        <NavItem icon={<FileSpreadsheet size={20}/>} label="Movimientos" active={activeTab === 'movimientos'} onClick={() => setActiveTab('movimientos')} />

        <NavItem icon={<DollarSign size={20}/>} label="Reg. Anticipo" active={activeTab === 'anticipo'} onClick={() => setActiveTab('anticipo')} />

        <NavItem icon={<Archive size={20}/>} label="Anticipos Archivados" active={activeTab === 'archivedAnticipos'} onClick={() => setActiveTab('archivedAnticipos')} />

        <NavItem icon={<SquareUser size={20}/>} label="Terceros" active={activeTab === 'terceros'} onClick={() => setActiveTab('terceros')} />
...
// import React from 'react';
// // Se agregan DollarSign y Archive
// import { FileText, Settings, Home, X, FileSpreadsheet, SquareUser, DollarSign, Archive } from 'lucide-react'; 
...
// import React from 'react';
// import { FileText, Printer, Settings, Home, X, FileSpreadsheet, SquareUser } from 'lucide-react';
