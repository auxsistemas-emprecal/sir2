        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-800 text-white">
              ...
              <th className="p-4 text-xs font-bold uppercase tracking-widest text-left">Observaciones</th> 
          ...
          <tbody className="divide-y divide-slate-100">
            {cuadres.map((c) => (
              <tr key={c.id} className="hover:bg-slate-50 transition-colors">
                ...
                <td className="p-4 text-slate-500 text-xs italic max-w-[200px] truncate" title={c.observaciones}>{c.observaciones || <span className="text-slate-300 italic">Sin notas</span>}</td>
