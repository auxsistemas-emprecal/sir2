...
import { 
  TrendingUp, Clock, Wallet, FileText, User, Download,
  SendHorizontal, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, 
  AlertCircle, CheckCircle2, Loader2
} from "lucide-react";

// IMPORTAMOS TUS SERVICIOS
import { updateMovimiento, fetchMovimiento } from "../assets/services/apiService";
  ...
  return (
    <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-linear-to-r from-emerald-800 to-emerald-700 p-6 rounded-2xl shadow-lg text-white">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Panel Contable</h2>
          <p className="text-emerald-100 text-sm opacity-90 font-medium">Gestión financiera y facturación</p>
        </div>
